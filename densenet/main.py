...
###################################### model setting #############################################################
DESCRIPTION = "DenseNet121, data argumentation(AutoAugmentPolicy.CIFAR10)" # 예시: 실험 내용 기록용(한글 작성시 깨짐)
...
model = DenseNet121()  # CIFAR10은 10 classes
...
with open(log_file_path, 'a') as log_file:
    log_file.write('model: Dense Net 121\n')
